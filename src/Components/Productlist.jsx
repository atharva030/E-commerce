...
const Songlist = ({handleburger}) => {
  ...
  const getmusic = async () => {
    const fetchereleased = await fetch("https://fakestoreapi.com/products");
  ...
  return (
    <>
    <div className="hamburger"><GiHamburgerMenu onClick={handleClick} /></div>
            

      <div className="main-container">
 
        <div className="flex-box">
          <h2 className=" f-hr-lines">NEW COLLECTION</h2>
          <div
